...
const sneakers = [
  ...
  },
  {
    ...
    color: 'White/Storm Blue-Varsity Red-Black',
    year: 2018,
    retail: '$190',
  ...
  },
  {
    ...
    model: 'Air Jordan 3',
    name: 'True Blue',
    color: 'White/Cement Grey-True Blue',
    year: 2011,
    retail: '$150',
  ...
  },
  {
    ...
    model: 'Air Jordan 3',
    name: 'True Blue',
    color: 'White/True Blue-Varsity Red',
    year: 2016,
    retail: '$220',
...
module.exports = {
  ...
  update: (id, updatedSneaker) => {
    id = parseInt(id);
    const sneaker = sneakers.find(sneaker => sneaker.id === id);
    Object.assign(sneaker, updatedSneaker)
  },
  deleteOne: (id) => {
    id = parseInt(id);
    const idx = sneakers.findIndex(sneaker => sneaker.id === id);
